...
import com.example.rectangulomvpapp.Modelo.TrianguloModelo

class TrianguloPresentar(private val vista: ContratoTriangulo.Vista): ContratoTriangulo.Presentador {
